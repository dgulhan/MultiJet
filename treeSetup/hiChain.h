...
public :
   ...
   // hiChain(TString infile="root://eoscms//eos/cms/store/caf/user/velicanu/PA2013_merged/PA2013_HiForest_Express_r210614_autoforest.root",TTree *tree=0);
   hiChain(TString infile,TChain *tree=0);
   virtual ~hiChain();
...
#ifdef hiChain_cxx
hiChain::hiChain(TString infile,TChain *tree) 
{
...
Int_t hiChain::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hiChain::LoadTree(Long64_t entry)
{
...
void hiChain::Show(Long64_t entry)
{
...
Int_t hiChain::Cut(Long64_t entry)
{
