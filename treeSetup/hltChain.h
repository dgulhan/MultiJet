...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   hltChain(TString infile, TChain *tree=0);
   virtual ~hltChain();
...
#ifdef hltChain_cxx
hltChain::hltChain(TString infile,TChain *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   
   tree = new TChain("hltanalysis/HltTree");
...
Int_t hltChain::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t hltChain::LoadTree(Long64_t entry)
{
...
void hltChain::Init(TChain *tree)
{
...
void hltChain::Show(Long64_t entry)
{
...
Int_t hltChain::Cut(Long64_t entry)
{
