...
void plotComparisonXCaKT(){
    ...
    TCut PbPbCuts[] = { " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3" , " pt1>100 && pt3>50 " , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3 " , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3" , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3" , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3 " , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3 " , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3" , " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3", " pt1>100 && pt3>50 && acos(cos(phi1-phi2))>2*TMath::Pi()/3" };
    ...
    TString TextCut[] = {"#Delta#phi_{1,2}> 2#pi/3" , " " , "#Delta#phi_{1,2}> 2#pi/3" , "#Delta#phi_{1,2}> 2#pi/3" , "#Delta#phi_{1,2}> 2#pi/3" , "#Delta#phi_{1,2}> 2#pi/3", " #Delta#phi_{1,2}> 2#pi/3" , "#Delta#phi_{1,2}> 2#pi/3" , "#Delta#phi_{1,2}> 2#pi/3" , "p_{T_1}^{gen}>0 p_{T_3}^{gen}>0 #Delta#phi_{1,2}> 2#pi/3"};
