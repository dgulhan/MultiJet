...
void plotCentralityBins(){
    ...
    c2->SaveAs(Form("aktCentrPt100%s.png",XLabel[iVar].Data()));
    c2->SaveAs(Form("aktCentrPt100%s.eps",XLabel[iVar].Data()));
    c2->SaveAs(Form("aktCentrPt100%s.gif",XLabel[iVar].Data()));
