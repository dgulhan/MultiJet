...
########   customization  area #########
NumberOfJobs= 11 # number of jobs to be submitted
interval = 200 # number files to be processed in a single job, take care to split your file so that you run on all files. The last job might be with smaller number of files (the ones that remain).
