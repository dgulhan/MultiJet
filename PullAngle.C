...
void PullAngle(){
    ...
    TCut cut1 = "genPt1>120 && genPt3>30 && acos(cos(genPhi1-genPhi2))>2*TMath::Pi()/3 && sqrt(pow(deltaPhi(genPhi3,genPhi2),2.)+pow(genEta2-genEta3,2.))<0.7" ;
    ...
    for ( int iFile = 0 ; iFile < nFiles; iFile++ ) {
        ...
        xcR4N3PF[iFile] = (TTree*)file[iFile]->Get("ak5PF");
        h[iFile] = new TH1D(Form("h%i",iFile),"akTR5_delta23=0.7_gen;#theta_{Pull 2,3};Event fraction",50,0,3.5);
